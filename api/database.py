...
# No Vercel, usamos /tmp para armazenamento persistente entre invocações
# Importante: dados podem ser perdidos em deployments. Considere usar um banco na nuvem para produção
if os.environ.get('VERCEL'):
    # Ambiente Vercel - usa /tmp (persistente durante a execução)
    DB_PATH = '/tmp/palpites.db'
else:
    # Ambiente local
    DB_DIR = Path(__file__).parent.parent
    DB_PATH = str(DB_DIR / 'palpites.db')
